	...
	window.onload = function(){
		...
		$(function(){
			...
			$("td.ct_btn:contains('중복확인')").bind("click", function(){
				...
				// Form 유효성 검증
				if($('input[name="userId"]').val() != null && $("#userId").val().length > 0) {
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						<input type="text" name="userId" id="userId" value="${! empty result && result ? userId : ''}" class="ct_input_g" style="width:100px; height:19px"  maxLength="20" />
					</td>
					<td>
